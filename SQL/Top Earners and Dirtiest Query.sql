/*To determine the top 10 most succesful Airbnb owners*/
USE airbnb; 
...
/*To determine the top 10 Airbnb owners with the most complaints of dirtiness*/
SELECT 
    host_id, host_url, host_name, COUNT(*) AS num_dirty_reviews
FROM
    reviews
        INNER JOIN
